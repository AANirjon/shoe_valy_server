...
// DB url setting 
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}cluster0.yfdrcxl.mongodb.net/?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
    res.send('Running ShoeValy Server Online');
});
app.listen(process.env.PORT || port, () => {
    console.log('Running ShoeValy server, port:', port);
});
